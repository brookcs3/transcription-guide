...
@section('title', 'Mac Transcription Software Reviews 2025 - Expert Analysis')
@section('meta_description', 'Comprehensive reviews of Mac transcription software. Expert analysis of offline apps, cloud services, and human transcription comparing privacy, accuracy, and pricing.')
@section('meta_keywords', 'Mac transcription reviews, offline transcription apps, cloud transcription services, transcription software comparison')

@section('og_title', 'Mac Transcription Software Reviews 2025')
@section('og_description', 'Expert reviews comparing offline and cloud transcription solutions for Mac')
@section('og_url', 'https://transcription.1oa.cc/reviews')
            ...
            <article class="article-card" style="display: grid; grid-template-columns: auto 1fr; gap: 2rem; align-items: center;">
                ...
                <div>
                    <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 0.5rem;">
                        <h3 style="margin: 0;"><a href="{{ url('/reviews/scriber-pro-review') }}">Scriber Pro</a></h3>
                    ...
                    <a href="{{ url('/reviews/scriber-pro-review') }}" style="display: inline-block; margin-top: 1rem; color: var(--primary-color); font-weight: 600;">Read complete Scriber Pro review: privacy analysis, accuracy testing, and pricing breakdown →</a>
                </div>
            </article>
        </div>
    </section>
    ...
    <section id="cloud-services" style="margin: 4rem 0;">
        ...
        <div style="display: grid; gap: 2rem;">
            <article class="article-card" style="display: grid; grid-template-columns: auto 1fr; gap: 2rem; align-items: center;">
                ...
                <div>
                    <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 0.5rem;">
                        <h3 style="margin: 0;"><a href="{{ url('/reviews/otter-ai-review') }}">Otter.ai</a></h3>
                    ...
                    <a href="{{ url('/reviews/otter-ai-review') }}" style="display: inline-block; margin-top: 1rem; color: var(--primary-color); font-weight: 600;">Read Otter.ai review including lawsuit details and privacy analysis →</a>
                </div>
            </article>
        </div>
    </section>
    ...
    <section id="human-services" style="margin: 4rem 0;">
        ...
        <div style="display: grid; gap: 2rem;">
            <article class="article-card" style="display: grid; grid-template-columns: auto 1fr; gap: 2rem; align-items: center;">
                ...
                <div>
                    <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 0.5rem;">
                        <h3 style="margin: 0;"><a href="{{ url('/reviews/rev-review') }}">Rev.com</a></h3>
                    ...
                    <a href="{{ url('/reviews/rev-review') }}" style="display: inline-block; margin-top: 1rem; color: var(--primary-color); font-weight: 600;">Read Rev.com review: human transcription accuracy vs cost analysis →</a>
                </div>
            </article>
        </div>
    </section>

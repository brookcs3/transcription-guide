...
<?php $__env->startSection('title', 'Mac转录软件评测2025 - 专家分析'); ?>
<?php $__env->startSection('meta_description', 'Mac转录软件综合评测。专家分析离线应用、云服务和人工转录的隐私性、准确性和价格比较。'); ?>
<?php $__env->startSection('meta_keywords', 'Mac转录评测, 离线转录应用, 云转录服务, 转录软件对比'); ?>

<?php $__env->startSection('og_title', 'Mac转录软件评测2025'); ?>
<?php $__env->startSection('og_description', '专家评测对比Mac离线和云转录解决方案'); ?>
<?php $__env->startSection('og_url', 'https://transcription.1oa.cc/zh/reviews'); ?>
...
<a href="<?php echo e(route('zh.home')); ?>">首页</a> &gt; <span>评测</span>
            ...
            <article class="article-card" style="display: grid; grid-template-columns: auto 1fr; gap: 2rem; align-items: center;">
                ...
                <div>
                    <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 0.5rem;">
                        <h3 style="margin: 0;"><a href="<?php echo e(url('/zh/reviews/scriber-pro-review')); ?>">Scriber Pro</a></h3>
                    ...
                    <a href="<?php echo e(url('/zh/reviews/scriber-pro-review')); ?>" style="display: inline-block; margin-top: 1rem; color: var(--primary-color); font-weight: 600;">阅读完整Scriber Pro评测:隐私分析、准确性测试和价格详解 →</a>
                </div>
            </article>
        </div>
    </section>
    ...
    <section id="cloud-services" style="margin: 4rem 0;">
        ...
        <div style="display: grid; gap: 2rem;">
            <article class="article-card" style="display: grid; grid-template-columns: auto 1fr; gap: 2rem; align-items: center;">
                ...
                <div>
                    <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 0.5rem;">
                        <h3 style="margin: 0;"><a href="<?php echo e(url('/zh/reviews/otter-ai-review')); ?>">Otter.ai</a></h3>
                    ...
                    <a href="<?php echo e(url('/zh/reviews/otter-ai-review')); ?>" style="display: inline-block; margin-top: 1rem; color: var(--primary-color); font-weight: 600;">阅读Otter.ai评测包括诉讼详情和隐私分析 →</a>
                </div>
            </article>
        </div>
    </section>
    ...
    <section id="human-services" style="margin: 4rem 0;">
        ...
        <div style="display: grid; gap: 2rem;">
            <article class="article-card" style="display: grid; grid-template-columns: auto 1fr; gap: 2rem; align-items: center;">
                ...
                <div>
                    <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 0.5rem;">
                        <h3 style="margin: 0;"><a href="<?php echo e(url('/zh/reviews/rev-review')); ?>">Rev.com</a></h3>
                    ...
                    <a href="<?php echo e(url('/zh/reviews/rev-review')); ?>" style="display: inline-block; margin-top: 1rem; color: var(--primary-color); font-weight: 600;">阅读Rev.com评测:人工转录准确性与成本分析 →</a>
                </div>
            </article>
        </div>
    </section>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Owner\transcription-guide\WORKING\transcription-guide-laravel\resources\views/pages/zh/reviews.blade.php ENDPATH**/ ?>
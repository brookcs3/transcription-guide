...
<?php $__env->startSection('title', 'Transcription Software Comparisons: Find Your Best Match'); ?>
<?php $__env->startSection('meta_description', 'Side-by-side comparisons of Mac transcription software. Compare offline vs cloud, pricing models, privacy features, and performance to find your perfect match.'); ?>

<?php $__env->startSection('og_title', 'Transcription Software Comparisons: Find Your Best Match'); ?>
<?php $__env->startSection('og_description', 'Side-by-side comparisons of Mac transcription software focusing on privacy, performance, and value for professionals'); ?>
<?php $__env->startSection('og_url', 'https://transcription.1oa.cc/comparisons'); ?>
...
<a href="<?php echo e(url('/')); ?>">Home</a> &gt; <span>Comparisons</span>
    ...
    <section style="margin: 4rem 0;">
        ...
        <div style="display: grid; gap: 2rem;">
            <article class="article-card">
                <a href="<?php echo e(url('/comparisons/scriber-pro-vs-otter')); ?>" style="text-decoration: none; color: inherit;">
            ...
            <article class="article-card">
                <a href="<?php echo e(url('/comparisons/scriber-pro-vs-rev')); ?>" style="text-decoration: none; color: inherit;">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Owner\transcription-guide\WORKING\transcription-guide-laravel\resources\views/pages/comparisons.blade.php ENDPATH**/ ?>